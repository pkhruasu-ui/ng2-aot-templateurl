/**
 * Created by spalaparty on 03/13/2017
 */
    ...
    TimelineAccordion.prototype._addEvent = function () {
        ...
        this.container.on("click", btnAddSel, function (e) {
            ...
            var root = $(e.target || e.currentTarget)
                ...
                var template = '<section class="sb-timeline"> <div class="row"> <div class="col-sm-3 pb-timeline-accordion" contenteditable="false"> <div class="sb-timeline-chapter-heading" contenteditable="true">' + '<h4>Timeline Chapter</h4> </div> </div>  <div class="col-sm-9 pb-timeline-accordion" contenteditable="false"> ' + 
                '<div class="sb-timeline-card sb-timeline-card-up" contenteditable="true">' +
                '<div class="sb-timeline-card-heading" data-tab-content-id="">' + 
                '<h4>' +
                'TimeLine Card Heading </h4> </div>' + 
                '<div class="sb-timeline-card-content tab-content" contenteditable="true">' + 
...
TimelineAccordion.prototype._postCompile= function (ele, event, ui) {
    ...
    TimelineAccordion.prototype._compile = function (ele, event, ui) {
        ...
        $(ele).data('pb.timeline-accordion.widget', data);
   ...
   $('div.sb-timeline-card-heading').off('click');
        $('div.sb-timeline-card-heading').click(function (e) {
            ...
            $(this).siblings('.sb-timeline-card-content').slideToggle();
    ...
    $.fn.PBTimelineAccordion = function () {
        return this.each(function () {
            if ($(this).data('pb.timeline-accordion') == undefined) {
                var pb = new TimelineAccordion(this);
                $(this).data('pb.timeline-accordion', pb);
            }
        })
    }
